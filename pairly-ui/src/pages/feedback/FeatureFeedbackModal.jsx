  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Choose an emoji that matches how you feel.
        </Typography>
      </DialogTitle>
      ...
      <DialogContent sx={{ textAlign: 'center', mt: 2 }}>
        <Stack direction="row" spacing={1} justifyContent="center" sx={{ mb: 2 }}>
          {[
            ...
            { emoji: '😐', label: 'Okay' },
            { emoji: '🙂', label: 'Good' },
            { emoji: '🤩', label: 'Loved it' }].map((emoji, i) => (
              <Tooltip title={emoji.label}>
                <Typography
                  ...
                  sx={{
                    ...
                    animation: formData.emojiRating === emoji.label
                      ? 'pop 0.6s ease-in-out infinite alternate' : 'none',
                    '@keyframes pop': {
        ...
        <TextField
          ...
          multiline
          minRows={3}
          label="How can we make this feature better?"
