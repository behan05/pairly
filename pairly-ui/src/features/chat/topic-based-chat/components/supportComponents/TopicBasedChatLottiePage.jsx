...
import topicBasedChatLottie from '@/assets/lottie/topicBasedChat.json';

function TopicBasedChatLottiePage() {
...
export default TopicBasedChatLottiePage;