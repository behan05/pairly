...
import AnonymousChatWindow from './components/coreComponents/AnonymousChatWindow';
import AnonymousChatController from './AnonymousChatController';
import React, { useState } from 'react';
import { useDispatch } from 'react-redux';

/**
 * AnonymousChatLayout component
 * - Main layout for Anonymous chat page
 * - Handles responsive sidebar and chat window display
 * - Passes state to child components via Outlet context
 * - Includes AnonymousController for socket/event logic
 */

function AnonymousChatLayout() {
  ...
  return (
    ...
    >
      ...
      >
        <AnonymousChatWindow setShowChatWindow={setShowChatWindow} />
      </Stack>

      {/* AnonymousController: handles socket events and chat logic in background */}
      <AnonymousChatController />
    </Box>
  );
}

export default AnonymousChatLayout;
